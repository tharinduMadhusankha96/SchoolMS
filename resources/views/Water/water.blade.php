...
@section('content')
    ...
    <table width="100%" border="0">
        <td bgcolor="#90ee90"width="50%">
            ...
            <h1 font-color="White" align="center" >Water Bill Payments</h1>
            ...
            <div class="col-md-12 animate-box fadeInUp animated-fast" width="50%">
                ...
                <div class="container" style="background-color: white">
                    ...
                    <form class="form-horizontal" action='{{Route('store')}}'>
                        ...
                        <div class="form-group{{ $errors->has('PaidDate') ? ' has-error' : '' }}">
            ...
            <form action="{{action('WaterController@index')}}" method="get">
        ...
        <td bgcolor="#90ee90"width="50%">
            ...
            <form action="{{action('WaterController@index')}}" method="post">
                {{ csrf_field() }}
