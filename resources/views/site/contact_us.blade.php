...
<div class="panel">
  <div class="panel-body">
    ...
    <br>
    <label><span class="fa fa-envelope"></span> Email: </label> surenanthonyvithanage@gmail.com<br>
    <label><span class="fa fa-phone"></span> Phone: </label> +976 9391251<br>
    <label>Address: </label> Athurugiriya , Sri lanka <br>
  </div>
    <div class="panel-footer">
      <button class="btn btn-success" onclick="window.open('mailto:surenanthonyvithanage@gmail.com')">Click Here To Mail Us</button>
    </div>
</div>
@endsection
