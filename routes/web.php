...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/PdfDemo', ['as' => 'PdfDemo' , 'uses' => 'pdf@index']);
    Route::get('/sample-pdf',['as' => 'SamplePDF' , 'uses' => 'pdf@samplePDF'] );

    Route::get('/report', function (Codedge\Fpdf\Fpdf\Fpdf $fpdf) {

        $fpdf->AddPage();
        $fpdf->SetFont('Courier', 'B', 18);
        $fpdf->Cell(50, 25, 'Generating Report');
        $fpdf->Output();
